...
module.exports = class CapOperatorAddDynamicTemplatesPlugin extends cds.add.Plugin {
    ...
    async run() {
        ...
        await copy(join(__dirname, '../files/chartDynamicTemplates/templates/_helpers.tpl')).to('chart/templates/_helpers.tpl')
        await copy(join(__dirname, '../files/chartDynamicTemplates/templates/service-binding.yaml')).to('chart/templates/service-binding.yaml')
        await copy(join(__dirname, '../files/chartDynamicTemplates/templates/service-instance.yaml')).to('chart/templates/service-instance.yaml')
        await cds.add.merge(__dirname, '../files/chartDynamicTemplates/cap-operator-cros.yaml.hbs').into('chart/cap-operator-cros.yaml.hbs', { project })
