...
module.exports = class CapOperatorBuildPlugin extends cds.build.Plugin {
    ...
    async copyTemplates() {
        ...
        await this.copy(path.join(__dirname, '../files/chart/templates/service-binding.yaml')).to(path.join(this.task.dest, 'templates/service-binding.yaml'))
        await this.copy(path.join(__dirname, '../files/chart/templates/service-instance.yaml')).to(path.join(this.task.dest, 'templates/service-instance.yaml'))
