...
module.exports = class CapOperatorAddPlugin extends cds.add.Plugin {
    ...
    async run() {
        if (cds.cli.options.force) await rimraf('chart')
            ...
            if (cds.cli.options['generate-runtime-values-via-prompt'] || cds.cli.options['generate-runtime-values-via-input-yaml'])
    ...
    async combine() {
        ...
        if (cds.cli.options['with-mta'] || cds.cli.options['generate-runtime-values-via-prompt'] || cds.cli.options['generate-runtime-values-via-input-yaml'])
            return
