...
module.exports = class CapOperatorAddPlugin extends cds.add.Plugin {
    ...
    async generateRuntimeValues() {
        ...
        if(cds.cli.options['generate-runtime-values-via-input-yaml']) {
            ...
            const answer = await ask('Enter CAP Operator subdomain (In kyma it is "cap-op" by default): ','Enter your cluster shoot domain: ', 'Enter your global account ID: ', 'Enter your provider subdomain: ', 'Enter your provider tenant ID: ', 'Enter your HANA database instance ID: ', 'Enter your image pull secrets: ')
