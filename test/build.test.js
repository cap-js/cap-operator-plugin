...
describe('cds build', () => {
    ...
    it('Build cap-operator chart', async () => {
        ...
        expect(getFileHash(join(__dirname,'../files/commonTemplates/cluster-domain.yaml'))).to.equal(getFileHash(join(bookshop, 'gen/chart/templates/cluster-domain.yaml')))
